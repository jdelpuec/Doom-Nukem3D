...
/*   Updated: 2020/02/19 16:24:33 by lubernar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				editdraw(t_sdl *sdl, t_editor *edit, t_line *line,
																t_lst **lst);
...
void				fill_list_without_x1(t_lst **lst, t_editor *edit,
																t_line *line);
...
void				draw_line_on_click(t_line *line, t_sdl *sdl,
																t_editor *edit);
...
void				find_walls_coord(t_sdl *sdl, t_editor *edit, t_line *line,
																t_lst **lst);
...
t_text_tab			display_next(t_sdl *sdl, t_sprite *s, t_text_tab tmp,
																t_editor *e);
