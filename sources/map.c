...
/*   Updated: 2020/01/13 13:20:59 by jdelpuec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_sector*	map()
{
	...
	t[0].walls[0].p2.y = -10;
	t[0].walls[0].portal_sector = 0;

	t[0].walls[1].p1.x = 2.5;
	t[0].walls[1].p1.y = -10;
	t[0].walls[1].p2.x = 10;
	t[0].walls[1].p2.y = -10;
	t[0].walls[1].portal_sector = 0;

	t[0].walls[2].p1.x = -10;
	t[0].walls[2].p1.y = 10;
	t[0].walls[2].p2.x = -2.5;
	t[0].walls[2].p2.y = 10;
	t[0].walls[2].portal_sector = 0;

	t[0].walls[3].p1.x = 2.5;
	t[0].walls[3].p1.y = 10;
	t[0].walls[3].p2.x = 10;
	t[0].walls[3].p2.y = 10;
	t[0].walls[3].portal_sector = 0;

	t[0].walls[4].p1.x = -10;
	t[0].walls[4].p1.y = -10;
	t[0].walls[4].p2.x = -10;
	t[0].walls[4].p2.y = 10;
	t[0].walls[4].portal_sector = 0;
	...
	t[2].walls[0].p2.y = -12;
	t[2].walls[0].portal_sector = 0;

	t[2].walls[1].p1.x = 2.5;
	t[2].walls[1].p1.y = -11;
	t[2].walls[1].p2.x = 2.5;
	t[2].walls[1].p2.y = -12;
	t[2].walls[1].portal_sector = 0;
	...
	t[3].walls[0].p2.y = -13;
	t[3].walls[0].portal_sector = 0;

	t[3].walls[1].p1.x = 2.5;
	t[3].walls[1].p1.y = -12;
	t[3].walls[1].p2.x = 2.5;
	t[3].walls[1].p2.y = -13;
	t[3].walls[1].portal_sector = 0;
	...
	t[4].walls[0].p2.y = -13;
	t[4].walls[0].portal_sector = 0;

	t[4].walls[1].p1.x = 2.5;
	t[4].walls[1].p1.y = -12;
	t[4].walls[1].p2.x = 2.5;
	t[4].walls[1].p2.y = -13;
	t[4].walls[1].portal_sector = 0;
	...
	t[5].walls[0].p2.y = -14;
	t[5].walls[0].portal_sector = 0;

	t[5].walls[1].p1.x = 2.5;
	t[5].walls[1].p1.y = -13;
	t[5].walls[1].p2.x = 2.5;
	t[5].walls[1].p2.y = -14;
	t[5].walls[1].portal_sector = 0;
	...
	t[6].walls[0].p2.y = -15;
	t[6].walls[0].portal_sector = 0;

	t[6].walls[1].p1.x = 2.5;
	t[6].walls[1].p1.y = -14;
	t[6].walls[1].p2.x = 2.5;
	t[6].walls[1].p2.y = -15;
	t[6].walls[1].portal_sector = 0;
	...
	t[7].walls[0].p2.y = -16;
	t[7].walls[0].portal_sector = 0;

	t[7].walls[1].p1.x = 2.5;
	t[7].walls[1].p1.y = -15;
	t[7].walls[1].p2.x = 2.5;
	t[7].walls[1].p2.y = -16;
	t[7].walls[1].portal_sector = 0;
	...
	t[8].walls[0].p2.y = -17;
	t[8].walls[0].portal_sector = 0;

	t[8].walls[1].p1.x = 2.5;
	t[8].walls[1].p1.y = -16;
	t[8].walls[1].p2.x = 2.5;
	t[8].walls[1].p2.y = -17;
	t[8].walls[1].portal_sector = 0;
	...
	t[9].walls[0].p2.x = -20;
	t[9].walls[0].p2.y = -17;
	t[9].walls[0].portal_sector = 0;

	t[9].walls[1].p1.x = -20;
	t[9].walls[1].p1.y = -17;
	t[9].walls[1].p2.x = -20;
	t[9].walls[1].p2.y = -37;
	t[9].walls[1].portal_sector = 0;

	t[9].walls[2].p1.x = -20;
	t[9].walls[2].p1.y = -37;
	t[9].walls[2].p2.x = 20;
	t[9].walls[2].p2.y = -37;
	t[9].walls[2].portal_sector = 0;

	t[9].walls[3].p1.x = 20;
	t[9].walls[3].p1.y = -37;
	t[9].walls[3].p2.x = 20;
	t[9].walls[3].p2.y = -17;
	t[9].walls[3].portal_sector = 0;

	t[9].walls[4].p1.x = 20;
	t[9].walls[4].p1.y = -17;
	t[9].walls[4].p2.x = 2.5;
	t[9].walls[4].p2.y = -17;
	t[9].walls[4].portal_sector = 0;
